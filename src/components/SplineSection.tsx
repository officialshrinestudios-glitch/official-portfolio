...
export function SplineSection() {
  ...
  useEffect(() => {
    // Delay initialization of the heavy 3D canvas until after the initial loader animations finish
  ...
  return (
    <section className="relative overflow-hidden section-padding z-10 bg-[#030303]">
      ...
      <div
        className="absolute top-1/2 left-1/4 w-[800px] h-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full pointer-events-none"
        style={{
          background: 'radial-gradient(circle, rgba(60,60,60,0.1) 0%, transparent 60%)'
        }}
      />
          ...
          <div className="flex-1 space-y-8 lg:space-y-12">
            ...
            >
              <p className="text-lg md:text-xl text-zinc-400 leading-[1.8] max-w-lg">
                We build websites that are not just conversion focused, but are ACTUALLY COOL.
              </p>
            </motion.div>
            ...
            >
              <a href="#services" className="inline-block group relative overflow-hidden rounded-full border border-white/10 bg-white/5 px-8 py-4 text-[10px] tracking-[0.25em] text-zinc-200 backdrop-blur-md transition-all hover:bg-white/10 hover:shadow-[0_0_30px_rgba(255,255,255,0.05)]">
